...
class ClientItemFetchingTest extends ClientTestCase
{
    ...
    {
        $this->forceFakeHttpClientResponseForUrl(
            'https://archive.org/metadata/hopefully-inexistent-identifier',
            'GET',
            200,
